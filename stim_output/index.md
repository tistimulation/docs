---
title: Testing Stimulator Outputs
layout: default
nav_order: 3
has_children: true
---
...
To record experimental results - please use the attached [Microsoft Excel spreadsheet](../TI_Workshop_HardwareTesting_Practical.xlsx).
...
Example resistance values for the H-Bridge will be used throughout the documentation. For your own tests in preparation of your TI experiment, the exact resistor values to be used should be determined according to the electrode montage to be used in human experiments and observed impedances there. [The guide for this process is here](./choosing_resistance.html).

The documentation will make reference to the following variables:
